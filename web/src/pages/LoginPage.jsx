    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card p-8 rounded-2xl border border-border/10 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-foreground">{t('auth.login.title')}</h1>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          {t('auth.login.no_account')} <Link to="/signup" className="text-primary hover:underline">{t('auth.login.signup_link')}</Link>
        </p>
      </div>
    </div>
  );
